...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    // These print statements show you (1)  all the relavant properties
	    if(earthquakes.size() > 0) {
	    	PointFeature pf = earthquakes.get(0);
//	    	System.out.println(pf.getProperties());
	    	Object obj = pf.getProperty("magnitude");
	    	float mag = Float.parseFloat(obj.toString());
	...
	{	
		...
		text("Below 4.0", 70, 215);
		
		fill(255, 0, 0);
		ellipse(50, 130, 12, 12);
